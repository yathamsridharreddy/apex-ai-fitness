...
export const DashboardPage: React.FC = () => {
  const { profile, logWater, setActiveTab, openOnboardingModal, enableHomeWorkoutMode } = useFitnessStore();
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              ...
              className="px-5 py-3.5 rounded-2xl bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-500 hover:to-green-500 text-white font-extrabold text-sm shadow-lg shadow-emerald-500/30 flex items-center space-x-2 transition"
            >
          ...
          <div className="space-y-3 text-xs">
            ...
            <div className="p-3.5 rounded-2xl bg-emerald-500/10 border border-emerald-500/25 text-emerald-200">
              <strong className="text-emerald-300 block mb-1 text-sm">
                🏠 No-Gym Home Option Available:
              </strong>
              No gym today? Click "No-Gym Home Workout" above to switch to Chair Bulgarian Split Squats & Doorframe Rows!
            </div>
          </div>
          <button
        ...
        <div className="glass-card p-6 space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-xs text-gray-400 mt-1">7 hrs 42 mins total • 2 hrs Deep REM</div>
            </div>
